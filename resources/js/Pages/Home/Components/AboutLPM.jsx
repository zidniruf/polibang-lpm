...
export default function AboutLPM({ setting }) {
    ...
    |--------------------------------------------------------------------------
    |
    | Gambar dan blok teks/tombol muncul dari arah berlawanan secara
    | bersamaan saat section terlihat, memberi kesan hidup tanpa
    | mengganggu konten.
    |
    */
    useEffect(() => {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-3 flex flex-col justify-center">
                            ...
                            <div className={`about-cta ${visible ? "is-visible" : ""} mt-8`}>
                                <a
